# 61d8862b-40a2-483a-9754-38bf9c018765 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `index-redesign.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `index-redesign.html`
...
- A single self-contained `index-redesign.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `index-redesign.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `index-redesign.html`
- `mp99b1gg-clashes.html`
- `mp99b1gz-documents.html`
- `mp99b1h4-index.html`
- `mp99b1ic-model.html`
- `mp99b1j4-settings.html`
- `mp99std-project-standard.html`

## Styles
- `mp99b1j6-workspace-shell.css`

## Scripts/components
- None detected

## Assets and supporting files
- `mp99b1f5-DESIGN-HANDOFF.md`
- `mp99b1fh-DESIGN-MANIFEST.json`
- `mp99b1fu-brand-spec.md`
- `mp99b1in-mp8it6e6-open-design-prompt.md`
- `mp9tdjw6-image.png`
- `mp9tjoks-image.png`
- `mp9tmqe0-image.png`

## Coding checklist for AI tools
1. Inspect `index-redesign.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
