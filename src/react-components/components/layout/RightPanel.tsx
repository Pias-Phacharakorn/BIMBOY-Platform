...
export function RightPanel({
  ...
  return (
    <div
      className={`relative z-10 flex flex-col h-full border-l border-border bg-surface/94 backdrop-blur-md transition-all duration-180 ease-in-out ${
    ...
    >
      ...
      <div className={`flex items-center h-[58px] border-b border-border bg-bg px-3.5 ${isOpen ? "justify-end" : "justify-center"}`}>
        ...
        >
          <Icon name={isOpen ? "PANEL_RIGHT_CLOSE" : "PANEL_RIGHT_OPEN"} size={20} />
        </button>
      </div>
