...
export function LeftPanel({
  ...
  return (
    <div
      ...
      className={`relative z-10 flex flex-col h-full border-r border-border bg-surface/94 backdrop-blur-md ${
    ...
    >
      ...
      <div
        ...
        className="absolute top-0 right-0 -mr-1 w-2 h-full cursor-col-resize z-20 group"
      >
