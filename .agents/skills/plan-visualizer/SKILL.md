...
The canonical version of this skill lives in [`.claude/skills/plan-visualizer/SKILL.md`](../../../.claude/skills/plan-visualizer/SKILL.md).

This `.agents/` copy is a pointer only — do not edit it. Update the `.claude/skills/` version instead.
